    ...
    <section id="topo" className="relative overflow-hidden pt-28">
      ...
      <div className="mx-auto max-w-4xl px-4 pb-20 text-center sm:px-6">
        ...
        <ul className="mx-auto mt-8 grid max-w-3xl gap-3 text-left text-sm text-white/85 sm:grid-cols-3">
          ...
          <li className="fp-surface fp-hover-lift fp-fade-up fp-fade-up-delay-1 rounded-xl p-4">Ativação simples com orientação passo a passo.</li>
          <li className="fp-surface fp-hover-lift fp-fade-up fp-fade-up-delay-2 rounded-xl p-4">Experiência fluida em diferentes dispositivos.</li>
        </ul>
